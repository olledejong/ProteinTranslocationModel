...
def dp_dt(y, t, k_s, k_d, k_in, k_in_mp, k_out, k_out_mp, average_nuclear_surface_area):
    """
    ...
    dC_dt = k_s + A * (-k_in * C / (Vc - Vn) + k_out * N / Vn) - k_d * C
...
def simulate(cell_vols, cyt_vols, nuc_vols, nuc_surf_areas):
    ...
    for i in range(params.num_cycles):
        ...
        sols_be = odeint(dp_dt, [cp0, np0], tspan_before, args=(
            params.ks, params.kd, params.kIn, params.kIn_mp, params.kOut, params.kOut_mp, average_nuc_surf_area
        ))
